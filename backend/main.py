    ...
    for attempt in range(max_retries):
        try:
            ...
            if attempt < max_retries - 1:
                ...
                print(f"❌ ERROR: Failed to connect to or initialize the database after {max_retries} attempts.")
                print(f"Please check your POSTGRES_URL and internet connection.")
